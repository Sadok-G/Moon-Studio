                        ...
                        <div class="d-flex justify-content-between">
                            <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                                <li class="moon-logo-space">
                                    <a href="#"><img src="moon-logo.png" alt="Moon Studio Logo" width="55"
                                            height="auto"></a>
                            ...
                            <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                                ...
                                <li class="dropdown notification-list topbar-dropdown">
                                    <a class="nav-link nav-user me-0" data-bs-toggle="dropdown" href="#"
                                        ...
                                        <img src="admin_logo.png" alt="user-image" width="40" height="40"
                ...
                <div class="card-lite p-3 p-md-4 rounded-2">
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" id="name" value="{{ $ad->user->name ?? '—' }}" name="name"
                                class="form-control field-form zoom-effect" placeholder="Jean-jacques" required
                                disabled />
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="description" name="description"  rows="10"
                                class="form-control field-form zoom-effect" placeholder="Short ads description, key points, compatibilities…">{{ old('ads_description', $ad->ads_description) }}</textarea>
                        </div>
